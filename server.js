...
app.get('/sap-approvals',    (req, res) => { res.set('Cache-Control', 'no-store'); res.sendFile(path.join(__dirname, 'public', 'sap-approvals.html')); });
app.get('/reports',          (req, res) => res.sendFile(path.join(__dirname, 'public', 'reports.html')));
app.get('/journal-entries',  (req, res) => res.sendFile(path.join(__dirname, 'public', 'journal-entries.html')));
app.get('/gl',               (req, res) => res.sendFile(path.join(__dirname, 'public', 'gl.html')));
